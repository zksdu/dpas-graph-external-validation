...
CKPTS = {"holdout_tonsil": "runs/lodo_v4_100ep/ckpt/holdout_tonsil",
         "holdout_breast_cancer": "runs/lodo_v4_100ep/ckpt/holdout_breast_cancer"}
...
def main():
    ...
    df.to_csv("results/gse_external_summary_100ep.csv", index=False)
    pp.to_csv("results/gse_external_per_protein_100ep.csv", index=False)
